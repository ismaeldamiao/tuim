...
%CC% /c /TP /EHsc /nologo /W4 /WX /O2 /GL /Zc:wchar_t /Zc:forScope /Zc:inline /Zi /Gm- /Od /Ob2 /Oi /Ot /Oy- /GT /GL- /Zl /Zp8 /Gy /Zc:__cplusplus /Zc:preprocessor /DTUIM_HOME="%TUIM_HOME%" /Fo.build\libtuim.obj src-loader\libtuim.c
